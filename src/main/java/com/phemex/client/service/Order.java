...
public interface Order {
    ...
    CompletableFuture<PhemexResponse<String>> cancelAll(String root, String symbol, boolean untriggered, String text);
    ...
    CompletableFuture<PhemexResponse<OrderModelVo>> createSpotOrder(CreateSpotOrderRequest spotOrderRequest);

    CompletableFuture<PhemexResponse<List<OrderModelVo>>> queryActiveOrders(String path, String symbol);
}
